...
vector<string> removeDuplicate(vector<string> vec){
...
int main() 
{   string input;
    vector<string> result, result2, result3,result_new;
    ifstream file;
    ...
    result_new=removeDuplicate(result);
    result2 = removeSpecialCharacter(result_new);
    ...
    cout<<" Most frequent word length :"<<mostFrequent(word_len)<<" Frequency :"<<count(word_len.begin(),word_len.end(),6)<<endl;
